...
import { TickUtilLibTest } from '../typechain-types';
...
describe('Tick Util Library', () => {
  ...
  describe('#TickCross', () => {
    ...
    //   await test.initializeTickState(tickSumA, tickSumBOutside, tickSumFPOutside, tickFeeGrowthOutsideShortsX128);
    ...
    //   const updatedSumFPOutside = globalSumFP.sub(
    ...
    //   expect(tick.feeGrowthOutsideShortsX128).to.eq(
    //     globalFeeGrowthGlobalShortsX128.sub(tickFeeGrowthOutsideShortsX128),
    //   );
    // });
  });
});
