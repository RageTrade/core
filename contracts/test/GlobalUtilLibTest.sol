...
contract GlobalUtilLibTest {
    ...
    function initializeTickState(
        int256 tickLowerSumA,
        int256 tickLowerSumBOutside,
        int256 tickLowerSumFPOutside,
        uint256 tickLowerFeeGrowthOutsideShortsX128,
        int24 _tickLowerIndex,
        int256 tickHigherSumA,
        int256 tickHigherSumBOutside,
        int256 tickHigherSumFPOutside,
        uint256 tickHigherFeeGrowthOutsideShortsX128,
        int24 _tickHigherIndex
    ) external {
