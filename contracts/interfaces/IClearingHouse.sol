...
interface IClearingHouse {
    ...
    event FundingPayment(uint256 accountNo, uint32 tokenPositionIndex, uint48 rangePositionIndex, int256 amount);
    event LiquidityFee(uint256 accountNo, uint256 rangePositionIndex, int256 amount);
}
